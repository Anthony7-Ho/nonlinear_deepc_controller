...
def generate_launch_description():
    ...
    random_joint_generator_node = Node(
        package='nonlinear_deepc_controller',
        executable='create_random_joint_trajectory',
        output='screen',
        parameters=[
            robot_description,
            robot_description_semantic,
    ...
    mode_arg = DeclareLaunchArgument(
        mode_parameter_name,
        default_value='train',
        description="Sampling mode: 'train' (30 waypoints) or 'validation' (15 waypoints).",
    )
